    ...
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout', function ($rootScope, $scope, $http, $modal, $timeout) {
        ...
        $scope.editorFactory.promise.then(function () {
            ...
            $scope.editor.registerOnEvent(ORYX.CONFIG.EVENT_SELECTION_CHANGED, function (event) {
                ...
                if (shapes && shapes.length > 0) {
                    ...
                    console.log("after:");
                    console.log($scope.propertyWindowState);
                    $scope.safeApply(function () {
                        $scope.selectedItem = {};
        ...
        $scope.updatePropertyInModel = function (property, shapeId) {
            ...
            var executionlisteners = {
                "executionListeners":[{
                        "event":"start",
                        "delegateExpression":"${approveUserTaskExecutionListener}"
                    }, {
                        "event":"take",
                        "delegateExpression":"${approveUserTaskExecutionListener}"
                    }, {
            ...
            var multiinstance_type = "Parallel";
            var multiinstance_cardinality = "";
            var multiinstance_collection = "assigneeList";
            var multiinstance_variable = "assignee";
                ...
                var commandClass = ORYX.Core.Command.extend({
                    ...
                    execute: function () {
                        ...
                        if(key === "oryx-usertaskassignment"){
                            this.shape.setProperty('oryx-multiinstance_type', multiinstance_type);
                            this.shape.setProperty('oryx-multiinstance_cardinality', multiinstance_cardinality);
                            this.shape.setProperty('oryx-multiinstance_collection', multiinstance_collection);
                            this.shape.setProperty('oryx-multiinstance_variable', multiinstance_variable);
                            this.shape.setProperty('oryx-executionlisteners', executionlisteners);
                            var passCondition = "${nrOfCompletedInstances/nrOfInstances >= "+this.newValue.assignment.passPercent+"}";
                            this.shape.setProperty('oryx-multiinstance_condition', passCondition);
                        }
                    ...
                    rollback: function () {
                        ...
                        if(key === "oryx-usertaskassignment"){
                            ...
                            this.shape.setProperty('oryx-multiinstance_collection', multiinstance_collection);
                            this.shape.setProperty('oryx-multiinstance_variable', multiinstance_variable);
                            var passCondition = "${nrOfCompletedInstances/nrOfInstances >= "+this.oldValue.assignment.passPercent+"}";
                            this.shape.setProperty('oryx-multiinstance_condition', passCondition);
                            this.shape.setProperty('oryx-executionlisteners', executionlisteners);
                        }
