    ...
    ACTIONS: {
        ...
        saveModel: function (services) {
          ...
          var option = {
            ...
            btn: parseInt("0011",2),
            onOk: function(){
              KISBPM.TOOLBAR.ACTIONS.saveModelAction(services);
              console.log("确认");
            }
          }
          window.wxc.xcConfirm(txt, window.wxc.xcConfirm.typeEnum.confirm, option);
        },
        saveModelAction:function(services){
            ...
            $http({
              ...
              data: params,
              ignoreErrors: true,
              headers: {'Accept': 'application/json', 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8','access_token':token},
        ...
        closeEditor: function(services) {
            if(parent&&parent.bt&&parent.bt.navtab){
                parent.bt.navtab.closeCurrent();
            }else{
                window.close();
            }
